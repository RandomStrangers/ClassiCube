...
#define GAME_MAX_CMDARGS 7
#define GAME_APP_VER "1.3.5"
#define GAME_API_VER 1

#if defined CC_BUILD_WEB
#define GAME_APP_ALT   "ClassiCube 1.3.5 web mobile + CPE Removal 1.13"
#define GAME_APP_NAME  "ClassiCube 1.3.5 web + CPE Removal 1.13"
#define GAME_APP_TITLE "ClassiCube 1.3.5 Removing CPE :P"
#elif defined CC_BUILD_ANDROID
#define GAME_APP_NAME  "ClassiCube 1.3.5 android alpha + CPE Removal 1.13"
#define GAME_APP_TITLE "ClassiCube 1.3.5 android alpha Removing CPE :P"
#elif defined CC_BUILD_IOS
#define GAME_APP_NAME  "ClassiCube 1.3.5 iOS alpha + CPE Removal 1.13"
#define GAME_APP_TITLE "ClassiCube 1.3.5 iOS alpha Removing CPE :P"
#else
#define GAME_APP_NAME  "ClassiCube 1.3.5 + CPE Removal 1.13"
#define GAME_APP_TITLE "ClassiCube 1.3.5 Removing CPE :P"
#endif
