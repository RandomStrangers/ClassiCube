...
static cc_bool cpe_twoWayPing; 
static cc_bool cpe_pluginMessages, cpe_extTextures, cpe_extBlocks;
...
static void CPE_Reset(void) {
	...
	cpe_extBlocks = false; Game_UseCPEBlocks = false; cpe_sendHeldBlock = false;
#if FULLCPE
	cpe_pluginMessages = false; cpe_blockPerms = false;
#endif
